        ...
        <>
            ...
            <div className="slider-container">
                <Slider {...settings} className="w-[70%] m-auto pb-10 text-center">
                    <div className="p-3">
                        <img src="https://picsum.photos/400/400" className="border-4 border-slate-800 w-[400px] h-[400px]" alt="Trainer 1"/>
                        <h3 className="text-white text-lg pt-2 pb-4 bg-slate-900 w-[400px] mx-auto">Trainer 1</h3>
                    </div>
                    <div className="p-3">
                        <img src="https://picsum.photos/400/400" className="border-4 border-slate-800 w-[400px] h-[400px]" alt="Trainer 2"/>
                        <h3 className="text-white text-lg pt-2 pb-4 bg-slate-900 w-[400px] mx-auto">Trainer 2</h3>
                    </div>
                    <div className="p-3">
                        <img src="https://picsum.photos/400/400" className="border-4 border-slate-800 w-[400px] h-[400px]" alt="Trainer 3"/>
                        <h3 className="text-white text-lg pt-2 pb-4 bg-slate-900 w-[400px] mx-auto">Trainer 3</h3>
                    </div>
                    <div className="p-3">
                        <img src="https://picsum.photos/400/400" className="border-4 border-slate-800 w-[400px] h-[400px]" alt="Trainer 4"/>
                        <h3 className="text-white text-lg pt-2 pb-4 bg-slate-900 w-[400px] mx-auto">Trainer 4</h3>
                    </div>
                </Slider>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 justify-evenly m-auto bg-slate-800 xl:px-20 text-white pb-14 mb-10 bg-opacity-80">
                <div className="w-[50%] text-center m-auto mt-4">
                    <img className="rounded-full m-auto mb-5" src="https://picsum.photos/150/150" alt="Modern Equipment"/>
